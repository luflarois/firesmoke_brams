...
contains
   ...
   subroutine writeTimeLineFRN_3d(fieldName,OutputField,mxp,myp,mzp,time,oneNamelistFile)
      ...
      !print *,'LFR-DBG - 3FN: ',fieldName
      !if(trim(fieldName)=='t2mj' .or. trim(fieldName)=='T2MJ') then !LFR-DBG
      !print *, 'LFR-DBG 3D: T2MJ: ', minval(OutputField),maxval(OutputField)
      !endif !LFR-DBG
   ...
   subroutine writeTimeLineFRN_2d(fieldName,OutputField,mxp,myp,time)
      ...
      !print *,'LFR-DBG - 2FN: ',fieldName
      !if(trim(fieldName)=='t2mj' .or. trim(fieldName)=='T2MJ') then !LFR-DBG
      !print *, 'LFR-DBG: T2MJ: ', minval(OutputField),maxval(OutputField)
      !endif !LFR-DBG
